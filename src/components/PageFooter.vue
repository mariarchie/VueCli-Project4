        ...
        <div class="footer center">
            <div class="footer__left">
                <div class="footer__logo">
                    <a class="logo" href="index.html"><img src="@/assets/Logo-2.svg" alt="logo"></a>
                    <a class="logo2" href="index.html"><img src="@/assets/Interno.svg" alt="logo"></a>
                </div>
                <p class="footer__statement">It is a long established fact that a reader will be distracted
                    lookings.
                </p>
                <div class="footer__info">
                    <a href="twitter.com" class="footer_icons"><svg width="19" height="16" viewBox="0 0 19 16" fill="none"
                    ...
                    <a href="linkedin.com" class="footer_icons"><svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
